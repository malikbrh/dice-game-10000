...
class Dice:
    ...
    def __init__(self, num_dice: int = 6) -> None:
    ...
    def get_possible_combinations(dice_values: List[int]) -> List[Tuple[int, List[int]]]:
        ...
        # i = 1 (binaire: 001) → combo = [1] (uniquement le premier dé)
        # i = 2 (binaire: 010) → combo = [2] (uniquement le deuxième dé)
        # i = 3 (binaire: 011) → combo = [1, 2] (premier et deuxième dés)
        # i = 4 (binaire: 100) → combo = [3] (uniquement le troisième dé)
        # etc.
